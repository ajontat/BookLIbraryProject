...
function toggleNavBar() {
            ...
            let client=null;
            let contractAddress="ct_xn8do1HfbXjrk4bX1vSCiUbLRb7o4tUh1H62yBFSEDJSUriKL";
            let contractSource=`
            contract BookLibraryContracts=
                record bookInfo={
                    name:string,
                    isbn:string,
                    date:string
            ...
            document.getElementById("submit-book").addEventListener("click",andleSubmitBook);
